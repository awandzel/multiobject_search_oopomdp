...
public class GridGameStandardMechanics implements FullJointModel {
	 ...
	 * @param i the index from which to generate possible outcomes in a visionDepth-first manner
	 * @param locArray an array holding the current assignments for a given visionDepth
