...
public class GraphTF implements TerminalFunction {
	...
	/**
	 * The set of nodes ids in the nodes that are terminal states
	 */
	...
	/**
	 * Removes graph as being marked as terminal states
	 * @param nodes the graph to remove as terminal states
	 */
