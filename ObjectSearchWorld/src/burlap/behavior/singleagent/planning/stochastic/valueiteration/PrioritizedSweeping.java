 ...
 * The priority queue takes Y*lg(N) time to manage at each step, where Y is the number of backpointers per state,
...
public class PrioritizedSweeping extends ValueIteration{
	...
	/**
	 * A node for state thar contains a list of its back pointers, their max probability of transition to this state, and the priority of this graph state.
	 * @author James MacGlashan
	 *
	 */
