...
public class BoundedRTDP extends DynamicProgramming implements Planner {
	...
	/**
	 * The maximum visionDepth/length of a rollout before it is terminated and Bellman updates are performed. If set to -1
	...
	/**
	 * Sets the maximum rollout visionDepth of any rollout. If set to -1, then there is no limit on rollout visionDepth.
	 * @param maxDepth the maximum rollout visionDepth of any rollout. If set to -1, then there is no limit on rollout visionDepth.
	 */
