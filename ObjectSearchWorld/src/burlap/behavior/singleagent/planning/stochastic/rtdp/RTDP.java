...
public class RTDP extends DynamicProgramming implements Planner{
	...
	/**
	 * The maximum visionDepth/length of a rollout before it is terminated and Bellman updates are performed.
	 */
	 ...
	 * @param maxDepth the maximum visionDepth/length of a rollout before it is terminated and Bellman updates are performed.
	 */
	...
	/**
	 * Sets the maximum visionDepth of a rollout to use until it is prematurely temrinated to update the value function.
	 * @param d the maximum visionDepth of a rollout.
	 */
