...
/**
 * UCT State Edge that wraps a hashed state object and provided additional state statistics necessary for UCT.
 * 
 * 
...
public class UCTStateNode {
	...
	/**
	 * The possible actions (graph) that can be performed from this state.
	 */
	 ...
	 * @param d the visionDepth of the node
