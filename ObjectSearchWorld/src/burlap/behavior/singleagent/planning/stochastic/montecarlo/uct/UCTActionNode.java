...
public class UCTActionNode {
	...
	/**
	 * The possible successor states. Stores a list of graph for the same outcome state
	 * since options may reach the same outcome state after a different number steps causing a further visionDepth in the tree.
	 */
	...
	/**
	 * Returns a list of all successor graph observed
	 * @return a list of all successor graph observed
	 */
