 ...
 * that is traded for less pruning power. If there is an imposed search visionDepth and a potential path will explore
 * a state in the memory, but will explore it at an earlier visionDepth, the valueFunction will explore it anyway, since it's
...
public class LimitedMemoryDFS extends DFS {
	...
	/**
	 * the size of the memory; that is, the number of recently expanded search graph the valueFunction will remember.
	 */
	protected int									memorySize;
	
	/**
	 * A queue for storing the most recently expanded graph.
	 */
	protected LinkedList<HashableState>			memoryQueue;
	
	
	/**
	 * Stores the visionDepth at which each state in the memory was explored.
	 */
	 ...
	 * @param memorySize the number of most recently expanded graph to remember.
	 */
	...
	/**
	 * Runs DFS from a given search node, keeping track of its current visionDepth. This method is recursive. The memory
	 * of the memorySize most recently expanded graph will be stored.
