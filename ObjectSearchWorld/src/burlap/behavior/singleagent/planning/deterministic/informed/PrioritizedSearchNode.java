 ...
 * cost to the node and the admissible heuristic from it. The priority is use to order graph for expansion.
...
public class PrioritizedSearchNode extends SearchNode {
	 ...
	 * are considered "less than" graph with higher priority.
	 * @author James MacGlashan
	 *
	 */
