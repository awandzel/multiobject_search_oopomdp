...
/**
 * Dynamic Weighted A* [1] uses a dynamic heuristic weight that is based on visionDepth of the current search tree and based on an expected visionDepth of the search. Specifically,
 ...
 *        {  0               if d(n) &gt; N,
 *        
 * where d(n) is the visionDepth of the search and N is the expected visionDepth of the search. This algorithm has the effect of becoming less
 ...
 * 
 * <p>
 * If a terminal function is provided via the setter method defined for OO-MDPs, then the BestFirst search algorithm will not expand any graph
...
public class DynamicWeightedAStar extends AStar {
	...
	/**
	 * The expected visionDepth required for a plan
	 */
	protected int											expectedDepth;
	
	/**
	 * Data structure for storing the visionDepth of explored states
	 */
	protected Map <HashableState, Integer>					depthMap;
	
	/**
	 * maintains the visionDepth of the last explored node
	 */
	 ...
	 * @param expectedDepth the expected visionDepth of the plan
	 */
	...
	/**
	 * Returns the weighted epsilon value at the given search visionDepth
	 * @param depth the search visionDepth
	 * @return the weighted epsilon value at the given search visionDepth
	 */
