...
public class IDAStar extends DeterministicPlanner {
	...
	/**
	 * The comparator to use for checking which graph to expand first.
	 */
	...
	public SDPlannerPolicy planFromState(State initialState) {
		...
		while(solutionNode == null){
			...
			if(solutionNode == null){
				DPrint.cl(debugCode, "Increase visionDepth to F: " + nextMinR);
			}
	...
	/**
	 * Recursive method to perform A* up to a f-score visionDepth
