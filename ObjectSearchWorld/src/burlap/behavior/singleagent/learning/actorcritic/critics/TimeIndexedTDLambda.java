...
public class TimeIndexedTDLambda extends TDLambda {
	...
	/**
	 * The time/visionDepth indexed value function
	 */
	protected List<Map<HashableState, VValue>>			vTIndex;
	
	/**
	 * The current time index / visionDepth of the current episode
	 */
	...
	/**
	 * Returns the current time/visionDepth of the current episodes
	 * @return the current time/visionDepth of the current episodes
	 */
	...
	/**
	 * Sets the time/visionDepth of the current episode.
	 * @param t the time/visionDepth of the current episode.
	 */
	...
	/**
	 * Returns the {@link TDLambda.VValue} object (storing the value) for a given hashed stated at the specified time/visionDepth.
	 * @param sh the hashed state for which the value should be returned.
	 * @param t the time/visionDepth at which the state is visited
	 * @return the {@link TDLambda.VValue} object (storing the value) for a given hashed stated at the specified time/visionDepth
	 */
	...
	/**
	 * Extends the standard {@link TDLambda.StateEligibilityTrace} to include time/visionDepth information.
	 * @author James MacGlashan
	 *
	 */
	public static class StateTimeElibilityTrace extends StateEligibilityTrace{
		...
		/**
		 * The time/visionDepth of the state this eligibility represents.
		 */
		public int timeIndex;
		
		
		/**
		 * Initializes with hashed state, eligibility value, time/visionDepth of the state, and the value function value associated with the state.
		 * @param sh the hashed input state for this eligibility
		 * @param time the time/visionDepth of the state at which it was first visited.
