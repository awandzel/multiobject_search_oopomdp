...
public class TabularModel implements KWIKModel {
	...
	/**
	 * A mapping from (hashed) states to state graph that store transition statistics
	 */
	...
	class StateNode{
		...
		/**
		 * Maps from actions to state-aciton graph that store statistics about the acitons taken from this state
		 */
