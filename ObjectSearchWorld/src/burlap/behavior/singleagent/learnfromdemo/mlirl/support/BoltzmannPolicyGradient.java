...
public class BoltzmannPolicyGradient {
	 ...
	 * @param beta the Boltzmann gamma parameter. This parameter is the inverse of the Botlzmann temperature. As gamma becomes larger, the policy becomes more deterministic. Should lie in [0, +ifnty].
     ...
     * @param beta the softmax gamma parameter. This parameter is the inverse of the Botlzmann temperature. As gamma becomes larger, the policy becomes more deterministic. Should lie in [0, +ifnty].
     * @return the gradient of the policy
     */
