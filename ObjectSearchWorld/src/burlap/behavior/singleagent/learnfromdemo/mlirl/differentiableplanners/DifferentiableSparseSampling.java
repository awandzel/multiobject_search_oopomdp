 ...
 * graph of this valueFunction may also be parametrized using a {@link burlap.behavior.singleagent.learnfromdemo.mlirl.differentiableplanners.diffvinit.DifferentiableVInit}
...
public class DifferentiableSparseSampling extends MDPSolver implements DifferentiableQFunction, QProvider, Planner {
	...
	/**
	 * The number of transition dynamics samples (for the root if visionDepth-variable C is used)
	 */
	protected int c;

	/**
	 * Whether the number of transition dynamic samples should scale with the visionDepth of the node. Default is false.
	 */
	...
	/**
	 * The state value used for leaf graph; default is zero.
	 */
	...
	/**
	 * The tree graph indexed by state and height.
	 */
	...
	/**
	 * Sets whether the number of state transition samples (C) should be variable with respect to the visionDepth of the node. If set
	 ...
	 * @param useVariableC if true, then visionDepth-variable C will be used; if false, all state graph use the same number of samples.
	 */
	...
	/**
	 * Sets the {@link burlap.behavior.valuefunction.ValueFunction} object to use for settting the value of leaf graph.
	 * @param vinit the {@link burlap.behavior.valuefunction.ValueFunction} object to use for settting the value of leaf graph.
	 */
	...
	/**
	 * A class for value differentiable state graph. Includes the state, a value estimate, whether the node has been closed and methods for estimating the Q and V values.
	 * @author James MacGlashan
	 *
	 */
