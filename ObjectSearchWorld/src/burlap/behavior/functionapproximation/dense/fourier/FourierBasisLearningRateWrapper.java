 ...
 * That is, if beta(j) is the learning rate returned by the source {@link LearningRate} implementation for basis function (feature id) j, then
 * this implementation will return beta(j) / ||c_j||, where c_j is the coefficient vector associated with Fourier baiss function j.
 * <p>
